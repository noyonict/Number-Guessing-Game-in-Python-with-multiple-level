...
def number_guessing_game(chances=10, high_value=100, l_no=1, mul_score=10):
    ...
    while True:
        chances -= 1
        if chances == 0:
            print('Sorry', getpass.getuser(), '! You lost.')
        ...
        if hidden_number > user_number:
            ...
            number_guessing_game(chances=new_chances, high_value=new_high_value, l_no=new_l_no, mul_score=new_score)
